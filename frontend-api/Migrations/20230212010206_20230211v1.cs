...
{
    public partial class _20230211v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Endereco", x => new { x.FuncionarioDbModelId, x.Id });
                    table.ForeignKey(
                        name: "FK_Endereco_Funcionarios_FuncionarioDbModelId",
